...
class ComplimentaryBookingController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($normalBookings->isNotEmpty()) {
            ...
            return response()->json(['status' => true, 'message' => 'ComplimentaryBookings deleted successfully'], 200);
        } else {
            return response()->json(['message' => 'ComplimentaryBookings not found']);
        }
    }
}
